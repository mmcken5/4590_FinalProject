...
server <- function(input,output){
  ...
  dcf_function <- function(){
    ...
    if (is.null(infile)){
      ...
      ExtraData <-as.character(unlist(read.csv(file = "TestCSV2.csv", header = FALSE,sep = ",")))
      for (i in 1:length(ExtraData)){    
        newData <- get_dcf_data(ExtraData[i])
        #newData$current_revenue
